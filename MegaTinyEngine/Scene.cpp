...
std::shared_ptr<Layer> Engine::Scene::addLayer(int layerId, ColorRGBA8 backgroundColor) { return m_layers.emplace_front(std::make_shared<Layer>(layerId, backgroundColor)); }

std::shared_ptr<Layer> Engine::Scene::addLayer(int layerId) { return m_layers.emplace_back(std::make_shared<Layer>(layerId)); }
