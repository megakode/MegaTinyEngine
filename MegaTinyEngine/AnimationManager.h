...
public:
    void addAnimationPreset(const std::string_view& id, const SpriteAnimation& animation);
    ...
    std::shared_ptr<SpriteAnimation> createAnimation(const std::string_view& preset_id, bool addToList = true);
    ...
    std::map<std::string_view, SpriteAnimation> getAllPresets();
...
private:
    ...
    std::map<std::string_view, SpriteAnimation> m_animationPresets;
